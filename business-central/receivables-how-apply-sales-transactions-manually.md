...
6. Use the **External Document No.** field to store an identifier, such as the customer's cheque number.
   ...
   > [!NOTE]
   > By default, the External Document No. field is hidden. If it is, and you want to use it, you can use personalization to add it. For more information, see [Personalise your workspace](ui-personalization-user.md).
