...
In this task, you add a registered app for Business Central in the Microsoft Entra tenant of your Microsoft 365 plan. Like other Azure services that work with Business Central, OneDrive requires a registered app in Microsoft Entra ID . The registered app provides authentication and authorisation services between Business Central and SharePoint, which is used by OneDrive.
