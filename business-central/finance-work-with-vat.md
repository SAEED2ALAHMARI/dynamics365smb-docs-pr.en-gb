...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-general-journals"></a>To set the system up for manual VAT entry in a general journals
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-after-you-complete-the-setup"></a>To create a new invoice for the import authority vendor once you have completed the setup
