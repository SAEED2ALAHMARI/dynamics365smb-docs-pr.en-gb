...
You must have either SUPER permissions in Business Central user account or one of the following Business Central licences:
...
- [Analyse list data with help of Copilot](analysis-assist.md)  
