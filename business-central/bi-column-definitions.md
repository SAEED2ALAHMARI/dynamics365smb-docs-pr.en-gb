...
1. Fill in the fields on the line as follows: 
    1. In the **Totalling Type** field, enter **Set Base for Percent**. 
    1. In the **Totalling** field, enter a formula for the total that the percentage is based on. For example, if row 11 contains the total sales, enter **11**.  
