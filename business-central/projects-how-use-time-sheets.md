...
## <a name="copy-project-planning-lines-to-a-time-sheet"></a>Copy job planning lines to a time sheet
...
## <a name="view-and-approve-time-sheets-by-project"></a>View and approve time sheets by job
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Approve or reject a time sheet by job
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Post time sheet lines in a job journal
