...
##### [Set up unrealised value added tax](finance-setup-unrealized-vat.md)
...
#### [Analyse finance data from the Chart of Accounts](finance-general-ledger.md)
...
### [Synchronise items and inventory with Shopify](shopify/synchronize-items.md)
### [Synchronise customers and companies with Shopify](shopify/synchronize-customers.md)
...
### [Set up VAT for the Shopify connection](shopify/setup-taxes.md)
### [Automate Shopify synchronisation using job queue](shopify/background.md)
...
### [Development of validated localisation apps](about-validated-localization-apps.md)
...
##### [Set up Belgian commodity codes](LocalFunctionality/Belgium/how-to-set-up-belgian-tariff-numbers.md)
...
##### [Registration number in the Icelandic localisation](LocalFunctionality/Iceland/use-registration-no.md)
...
##### [Plan your holiday](LocalFunctionality/Russia/Vacation-planning.md)
...
#### [Register new items](inventory-how-register-new-items.md)
#### [Create new items by copying existing items](inventory-how-copy-items.md)
#### [About item types](inventory-about-item-types.md)
#### [Set up units of measure](inventory-how-setup-units-of-measure.md)
#### [Set up stock keeping units](inventory-how-to-set-up-stockkeeping-units.md)
#### [Categorise items](inventory-how-categorize-items.md)
...
#### [Enable automatic break bulk with directed put-away and pick](warehouse-enable-automatic-breaking-bulk-with-directed-put-away-and-pick.md)
#### [Enable FEFO method to pick items](warehouse-picking-by-fefo.md)
...
#### [Set up the price and additional costs for services](service-how-setup-service-costs-pricing.md)
...
##### [Access data in Teams without Business Central licence](teams-access-with-m365-license.md)
...
#### [View work centre ledger entries](production-how-to-post-capacities.md#to-view-work-center-ledger-entries)
...
#### [Compress data or delete documents to manage storage](admin-manage-documents.md)
...
#### [Cloud migration base](ui-extensions-intelligent-cloud.md)
...
### [Data ownership models for synchronisation](admin-cds-company-concept.md)
...
### [Synchronise Business Central and Microsoft Dataverse](admin-synchronizing-business-central-and-sales.md)
### [Map the tables and fields to synchronise](admin-how-to-modify-table-mappings-for-synchronization.md)
...
### [Use a Power Automate flow to timely synchronise Dataverse entity changes](admin-power-automate-flow-dataverse.md)
...
### [Managing migration to the cloud](/dynamics365/business-central/dev-itpro/administration/migration-manage?toc=/dynamics365/business-central/toc.json)
