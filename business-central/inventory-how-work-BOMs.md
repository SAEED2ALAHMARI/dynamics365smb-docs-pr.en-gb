...
The concept of resources in production is much more advanced than in assembly management. Work centres and machine centres act as resources. The operations assigned to resources in production routings represent production steps. Learn more at the [Create Routings](production-how-to-create-routings.md) article.
