...
3. If your warehouse requires, enter your user ID when you start work on a put-away.  
    ...
    You can sort the put-away lines by various criteria, for example, by item, shelf number, or due date. Sorting can help optimise the put-away process, for example:
