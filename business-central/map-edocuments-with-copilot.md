...
> [!IMPORTANT]
> - This is a Production Ready Preview feature for production and sandbox environments in any country localisation, with the exception of Canada.
...
## <a name="to-activate-copilot"></a>To activate Copilot
...
3. After a few seconds, the **E-Document Match Order Lines with Copilot** will suggest lines for matching with some more details: 
    ...
    4. All fully suggested and matched lines are marked with green colour. If there's any issue, for example, different price, but in the allowed price range, this line will be marked with yellow colour, and if there's any similarity between the description fields, but the price difference is bigger than allowed, this line will be marked with red colour. 
