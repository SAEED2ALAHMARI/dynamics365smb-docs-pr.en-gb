...
## <a name="about-the-vat-return-report"></a><a name="vatreturn"></a>About the VAT Return report
...
## <a name="to-set-up-vat-reports-in-"></a>To set up VAT reports in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a>To set up VAT return periods
