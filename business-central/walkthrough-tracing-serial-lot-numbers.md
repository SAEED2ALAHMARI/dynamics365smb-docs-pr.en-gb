...
3.  To open the sales line record, select the second Find Entries line, choose the **Show** action. Alternatively, choose the value in the **No. of Records** field.  
    ...
    Here the quality controller sees one open sales line for the faulty racing frames. They immediately suggest to the sales department that this order be cancelled and a new production order, based on good racing frames, be initiated.  
