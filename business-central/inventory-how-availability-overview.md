...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-its-stored"></a>To view the availability of an item at the locations where it's stored
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-theyre-stored"></a>To view the availability of all items by the location where they're stored
