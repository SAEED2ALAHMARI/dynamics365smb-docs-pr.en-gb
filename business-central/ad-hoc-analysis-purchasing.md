...
description: Learn how to use the data analysis mode to analyse data in purchasing.
author: kennienp
ms.author: kepontop
...
1. Personalise the page to add the **Amount Received Not Invoiced** field. To personalise the page, choose **Settings**, and then **Personalise**.
