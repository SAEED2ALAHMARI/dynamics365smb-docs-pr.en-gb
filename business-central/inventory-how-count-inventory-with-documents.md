...
## <a name="to-create-a-physical-inventory-recording"></a>To create a physical inventory recording
...
## <a name="handle-item-tracking-when-counting-inventory"></a>Handling Item Tracking when Counting Inventory
...
> [!NOTE]
> The available reports may vary based on localisation for your country/region. The base application doesn't include any layouts.
