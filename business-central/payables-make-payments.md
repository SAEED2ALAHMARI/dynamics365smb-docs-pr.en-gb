...
From the payment journal, you can print computer cheques or record when cheques are written. If you select **Computer Cheque** in the **Bank Payment Type** field, you must print lines that represent cheques before you can post the payment journal.
