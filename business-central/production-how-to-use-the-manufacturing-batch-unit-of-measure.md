...
---
# Work with Manufacturing Batch Units of Measurement
...
## To create a production BOM using a batch unit of measurement  
...
## To calculate a manufacturing batch unit of measurement on a production order  
