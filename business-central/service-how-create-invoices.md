...
5. Choose **Post**, and then either **Invoice** or **Ship and Invoice**. To learn more, go to [Posting in Service Management](service-service-posting.md).  
...
5. Enter a date in the **Posting Date** field. This date will appear on the posted entries. This field shows your current work date, but you can change the date.  
6. In the **Document Date** field, enter a date that will appear on the printed invoice and be used to calculate the due date.  
