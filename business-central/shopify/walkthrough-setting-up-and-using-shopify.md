...
7. Select **OK** and wait until initial synchronisation of items, prices, images and inventory is completed.
...
8. Select **OK** and wait until initial synchronisation of items, prices, images and inventory is completed.
...
In **Shopify Admin** create and assign catalogue.

1. Select **Products** and then **Catalogues** in the sidebar of **Shopify admin**.
2. Create catalogue for Specific products. Give in title 'B2B'. 
3. Choose **Manage** and then **Manage products and pricing**.
4. Select *Excluded* filter, find *ATHERN Desk* and choose **Include in catalogue**.
5. Select **Customers** and then **Companies** in the sidebar of **Shopify admin**.
6. Select *School of Fine Art* and choose **[...]** and then **Add catalogues** and add *B2B* catalogue created earlier.
...
7. Select entry with name *B2B* catalogue for which you want to synchronise prices.
...
In **Shopify Admin**, explore prices for *B2B* catalogue.
...
8. Explore product catalogue, you should be able to see only product added to the *B2B* catalogue with retail special prices.
