...
11. Optionally, in the **Inv. Discount Amount** field, enter the amount to be deducted from the value shown in the **Total Incl. VAT** field.

    If you set up invoice discounts for the customer, and upon meeting the criteria, the specified percentage value is automatically inserted in the **Invoice Discount %** field. And the related amount is inserted in the **Inv. Discount Amount Excl. VAT** field. Learn more at [Record Sales Price, Discount, and Payment Agreements](sales-how-record-sales-price-discount-payment-agreements.md).
