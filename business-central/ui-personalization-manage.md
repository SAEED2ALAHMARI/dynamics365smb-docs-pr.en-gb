...
- Not all table fields may be available for customisation from the **Add field to page** pane. The developer of a table can choose to prevent a field from appearing in customisation by setting the field's [AllowInCustomisation property](/dynamics365/business-central/dev-itpro/developer/properties/devenv-allowincustomizations-property) to `Never`.
