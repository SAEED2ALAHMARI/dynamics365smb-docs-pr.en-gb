...
* **Business Central Dataverse Integration** - Allows you to manage the connection between [!INCLUDE [prod_short](includes/prod_short.md)] and [!INCLUDE [cds_long_md](includes/cds_long_md.md)]. Typically, this is assigned only to the automatically created user account for synchronisation.

> [!NOTE]
> Only the application user who runs the integration should have the **Business Central Dataverse Integration** role. The application user doesn't need the [!INCLUDE [prod_short](includes/prod_short.md)] or [!INCLUDE [cds_long_md](includes/cds_long_md.md)] licences.
