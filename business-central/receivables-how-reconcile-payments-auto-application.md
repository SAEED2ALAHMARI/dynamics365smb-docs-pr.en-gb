...
When you use automatic application, [!INCLUDE[prod_short](includes/prod_short.md)] recognises bank ledger entries that have already been posted, which helps prevent double-posting.
