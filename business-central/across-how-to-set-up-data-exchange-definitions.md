...
description: 'Define how Business Central exchanges data with external files like electronic documents, bank data, item catalogues and more.'
author: brentholtorf
ms.author: bholtorf
...
|Option|Description|
|---------|---------|
|**Uppercase**|Capitalise all letters.|
