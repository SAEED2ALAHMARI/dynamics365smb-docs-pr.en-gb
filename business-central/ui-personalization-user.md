...
|Show an action or part that is currently hidden|For a greyed (hidden) element, choose the arrowhead, and then choose <b>Show</b>.|The hidden element is visible again.|
