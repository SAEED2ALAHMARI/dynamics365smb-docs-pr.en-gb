...
---
# <a name="walkthrough-managing-projects"></a>Walkthrough: Managing Projects with Jobs
...
### <a name="setting-up-a-project"></a>Setting Up a Job
...
### <a name="to-create-a-project-journal-batch"></a>To create a Job Journal batch
...
## <a name="setting-up-a-project-1"></a>Setting Up a Job
...
### <a name="to-set-up-a-project"></a>To set up a job
...
6.  On the **Foreign Trade** FastTab, set the currency code to **GBP**. If you select GBP in the **Invoice Currency Code** field, then the job will be invoiced in British Pounds and planned in the local currency of CRONUS only.  
...
5.  On the **Job Item Prices** page, enter the following information and customised price:  
...
### <a name="to-add-project-tasks"></a>To add job tasks
...
### <a name="to-enter-hours-in-a-project-journal"></a>To enter hours in the Job Journal
...
## <a name="copying-projects"></a>Copying Jobs
...
### <a name="to-copy-a-project"></a>To copy a job
