...
- Creating payment by instalments for a project.  
...
6. On the **Foreign Trade** FastTab, set the currency code to **GBP**. If you select GBP in the **Invoice Currency Code** field, then the project will be invoiced in British pounds and planned in the local currency of CRONUS only.  
