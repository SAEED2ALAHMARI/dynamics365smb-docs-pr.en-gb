...
### Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work with any localisation of [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams cater to my customisation and personalisation?
...
### Does this show lists and records from my customisations and add-ons?
...
### Does [!INCLUDE [prod_short.md](includes/prod_short.md)] synchronise contacts with Teams?
...
### Can I share cards with users outside my organisation?
