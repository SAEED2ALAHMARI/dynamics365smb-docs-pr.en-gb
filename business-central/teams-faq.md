...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a>How do I sign in to the [!INCLUDE [prod_short.md](includes/prod_short.md)] app in Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a>How do I sign out of the [!INCLUDE [prod_short.md](includes/prod_short.md)] app in Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a>Does the app for Teams connect to [!INCLUDE [prod_short.md](includes/prod_short.md)] on-premises?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a>In which countries or regions is the [!INCLUDE [prod_short.md](includes/prod_short.md)] app available?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work with any localisation of [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="language"></a>Which languages does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app support?
...
### <a name="does-the--app-work-with-industry-solutions"></a>Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work with industry solutions?
...
### <a name="does--work-with-the-teams-mobile-app"></a>Does [!INCLUDE [prod_short.md](includes/prod_short.md)] work with the Teams mobile app?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Is the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams the same as the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for iOS and Android?
...
### <a name="does-the--app-work-in-all-teams-clients"></a>Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app work in all Teams clients?
...
### <a name="which-teams-client-is-best-for-"></a>Which Teams client is best for [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>What is the best way for me to demonstrate [!INCLUDE [prod_short.md](includes/prod_short.md)] and Microsoft Teams to prospective customers?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Does the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams cater to my customisation and personalisation?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a>How do I uninstall the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Will Microsoft continue to improve the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams?
...
The recommended content that you can choose from in the **Tab content** option on a tab is based on your Role Centre. The recommend content only includes list pages, like Customers, Sales Orders, and Vendors - not individuals card page alike a specific customer or vendor.
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a>Can I call a contact from the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Are [!INCLUDE [prod_short.md](includes/prod_short.md)] contacts different than the ones in the Teams contacts screen?
...
### <a name="does--synchronize-contacts-with-teams"></a>Does [!INCLUDE [prod_short.md](includes/prod_short.md)] synchronise contacts with Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a>What is the minimum version of [!INCLUDE [prod_short.md](includes/prod_short.md)] for contact search?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Why don't cards show more information instead of just the page name and details button?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Will others see my card if they don't have the [!INCLUDE [prod_short.md](includes/prod_short.md)] app for Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>How do I find out which company a card in Teams belongs to?
...
Yes. If you're using the Teams desktop app, start a call by choosing the linked number in a phone number field, like the **Mobile Phone No.** field on the **Contact** card. Teams must be your designated dialling app.
...
### <a name="how-does-a-guest-user-install-the--app"></a>How does a guest user install the [!INCLUDE [prod_short.md](includes/prod_short.md)] app?
