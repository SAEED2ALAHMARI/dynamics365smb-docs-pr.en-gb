...
You add users in Microsoft 365 admin centre. For more information, see [Create Users According to Licences](ui-how-users-permissions.md).
...
The [quick start](quick-start-business-central.md) articles can help you take the first steps into setting up [!INCLUDE [prod_short](includes/prod_short.md)] for your organisation. Inside [!INCLUDE [prod_short](includes/prod_short.md)], the **Assisted Setup** page lists the assisted setup guides that can help you. Depending on your role and country/region, the page shows different assistant setup guides as illustrated in the following table:
