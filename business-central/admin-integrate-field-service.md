...
> [!NOTE]
> When product or service on a work order status changes from **Estimated** to **Used** in [!INCLUDE [field-service-short](includes/field-service-short.md)], they'll synchronise to project journal lines in [!INCLUDE [prod_short](includes/prod_short.md)].
