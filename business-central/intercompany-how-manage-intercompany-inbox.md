...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period"></a>Get an overview of intercompany transactions for a period
...
## <a name="import-intercompany-transactions-from-a-file"></a>Import intercompany transactions from a file
...
## <a name="process-incoming-intercompany-transactions"></a>Process incoming intercompany transactions
...
## <a name="recreate-intercompany-inbox-transactions"></a>Recreate intercompany inbox transactions
