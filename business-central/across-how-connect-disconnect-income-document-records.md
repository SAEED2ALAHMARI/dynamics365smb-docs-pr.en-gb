...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice"></a>Create and connect an incoming document record from a purchase invoice
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry"></a>Create and connect an incoming document record from a vendor ledger entry
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document"></a>Remove a connection from an incoming document record to a posted document
