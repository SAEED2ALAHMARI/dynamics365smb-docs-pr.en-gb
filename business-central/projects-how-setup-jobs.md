...
| **Recognized Costs Account** |The expense account that contains the recognised costs for the project. It is a debit expense account ordinarily. | Recognised Costs|
| **Recognized Sales Account** |The income account that contains the recognised income for the project. It is a credit income account ordinarily. | Recognised Sales|
