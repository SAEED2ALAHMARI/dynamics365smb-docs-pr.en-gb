...
After you set up your inventory, you can manage various processes related to item transactions. For more information, see [Manage Inventory](inventory-manage-inventory.md) and [Warehouse Management Overview](design-details-warehouse-management.md).
...
| Create item cards for inventory, noninventory, or service items that you trade in. |[Register New Items](inventory-how-register-new-items.md) |
...
|Set up multiple units of measure (UOM) for an item that you can use as alternate UOMs, for example, on sales, purchasing, or production transactions.|[Set Up Item Units of Measure](inventory-how-setup-units-of-measure.md)|
|As a supplement to item cards, record information about your items in a specific location or of a specific variant.|[Set Up Stock Keeping Units](inventory-how-to-set-up-stockkeeping-units.md)|
