...
This article explains how to use *analysis assist* to help you analyse data on list pages.
...
1. In the **Analyse Items** with Copilot window, enter a description of the layout you want. This description is known as a *prompt*.
