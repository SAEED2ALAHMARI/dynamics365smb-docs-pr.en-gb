...
- Pin a customised view to the dashboard to continue tracking.  
...
> [!TIP] 
> You can also access the **Power BI Report** from [!INCLUDE [prod_short](includes/prod_short.md)]. Navigate to the Power BI Reports section and **Select reports** on your Home page. Choose either **Services** or **My Organisation** from **Get Reports**. The Organisation gallery in Power BI or Microsoft AppSource will open, displaying only apps related to [!INCLUDE[prod_short](includes/prod_short.md)].
