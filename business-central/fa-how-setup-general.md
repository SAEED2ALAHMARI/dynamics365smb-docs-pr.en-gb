...
## To set up general behaviour for fixed assets functionality

Define the general behaviour of the fixed asset functionality and its document number series on the **Fixed Assets Setup** page.
...
8. After you enter and post the journal lines for each asset, turn on general ledger integration in the depreciation books.
