...
## <a name="pick-or-move-for-production-assembly-and-projects-in-a-basic-warehouse-configuration"></a>Pick or move for production, assembly, and projects in a basic warehouse configuration
